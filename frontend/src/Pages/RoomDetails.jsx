...
const RoomDetails = () => {
  ...
  return (
    <div className="py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32">
      ...
      <form onSubmit={submitHandler} className="flex flex-col md:flex-row items-start md:items-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl">
        ...
        >
         {isAvailable?(loading?"Booking":"Book Now"): loading?"Checking":" Check Availability"}
        </button>
      </form>
